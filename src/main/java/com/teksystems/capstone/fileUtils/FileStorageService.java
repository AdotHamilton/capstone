package com.teksystems.capstone.fileUtils;

import com.teksystems.capstone.configuration.FileStorageProperties;
import com.teksystems.capstone.exception.FileStorageException;
...
public class FileStorageService {
    ...
    public String saveFile(MultipartFile multipartFile, String subDir) throws IOException {
        ...
        try {
            Path filePath = this.fileStorageLocation.resolve(subDir); // destination = filepath + subdir
